...
/// <summary>
/// Interface para processador de instalação de dependências.
/// </summary>
public interface IDependencyInstallationProcessor : IExecutionProcessor
{
    /// <summary>
    /// Processa uma tarefa de instalação de dependências.
    /// </summary>
